...
/copy qmodsrc,iasrv01pr
/copy qmodsrc,iasrv02pr
/copy qmodsrc,iasrv03pr
/copy qmodsrc,iagetkwdpr                                                                 //0032
/copy qcpysrc,rpgIVds                                                                         //0003
/copy qcpysrc,rpgIIIds                                                                        //0012
...
dcl-proc IaPrCrtObj export;
   ...
   If %scan('OBJTYPE(*FILE)': w_ClStatement) > 0;                                        //0026
      ...
      exec sql
         insert into IAPGMFILES (IALIBNAM,                                               //0061
                                 IASRCFILE,                                              //0061
                                 IAMBRNAME,                                              //0061
                                 IAACTFILE,                                              //0061
                                 IAACTRCDNM)                                             //0061
            values(trim(:w_IAPGMFILES.IALIBNAM),                                         //0061
                   trim(:w_IAPGMFILES.IASRCFILE),                                        //0061
                   trim(:w_IAPGMFILES.IAMBRNAME),                                        //0061
                   trim(:w_IAPGMFILES.IAACTFILE),                                        //0061
                   trim(:w_IAPGMFILES.IAACTRCDNM));                                      //0061
